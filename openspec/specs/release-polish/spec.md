...
Release polish defines the accessibility, packaging, signing, release notes, and launch-performance gates required before shipping the portable BS2BG release.
