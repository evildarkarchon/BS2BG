...
[SuppressMessage("Performance", "CA1822:Mark members as static",
    Justification = "Morph generation is exposed as an injectable service surface.")]
public sealed class MorphGenerationService
{
    ...
    {
        if (customTargets is null) throw new ArgumentNullException(nameof(customTargets));
