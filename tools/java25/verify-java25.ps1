...
$requiredSuites = @(
    ...
    'com.asdasfa.jbs2bg.presentation.OutputArtifactPublisherTest',
    'com.asdasfa.jbs2bg.presentation.OutputRoutePolicyTest',
    ...
    'com.asdasfa.jbs2bg.workbench.morphs.MorphsFeatureTest',
